...
* This lab is designed to install and configure Red Hat Connectivity Link (RHCL) with a specific use case to implement its features, focusing on different user roles:
...
* Configure DNS and TLS for Gateway API, including AWS credentials and Let’s Encrypt setup.
