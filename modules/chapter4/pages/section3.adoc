...
* Test **/cars** endpoint with **regular user** API Key.
** Use the API_KEY for the **regular user** to access the **/cars** endpoint:
+
[subs="+quotes,+macros"]
----
...
** Test **/admin** endpoint with admin user API Key
*** Use the API_KEY for the admin user to access the **/admin** endpoint:
+
[subs="+quotes,+macros"]
----
